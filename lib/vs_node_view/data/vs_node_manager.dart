import 'package:ai_gen/vs_node_view/common.dart';
import 'package:ai_gen/vs_node_view/data/vs_node_data.dart';
import 'package:ai_gen/vs_node_view/data/vs_node_serialization_manager.dart';
import 'package:ai_gen/vs_node_view/special_nodes/vs_output_node.dart';
...
class VSNodeManager {
  ...
  VSNodeManager({
    required List<dynamic> nodeBuilders, //A list of builders that define how to create different types of nodes.
    
    String? serializedNodes,  // A string representation of previously serialized nodes, which can be deserialized to restore the state.
    this.onNodesUpdate,
